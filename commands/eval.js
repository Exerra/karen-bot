...
module.exports = {
	...
	async execute(client, msg, args) {
		...
		if (result.length > 1024 && result.length < 80000) {
			hastebin(result, { extension: lang.extension, url: 'https://www.toptal.com/developers/hastebin' /*https://paste.exerra.xyz'*/} ).then(haste => msg.channel.send(`Result was too big: ` + haste))
		} else if(result.length > 80000) {
			msg.channel.send(`I was going to send this in a hastebin, but the result is over 80,000 characters dumbass`)
		} else {
